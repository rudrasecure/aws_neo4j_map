...
class RDS:
    ...
    def get_rds_details(self, region):
    ...
    def get_all_rds_details(self):
        ...
        for region in regions:
            ...
            dbs = self.get_rds_details(region_name)
            all_rds_details[region_name] = dbs

        return all_rds_details

    def main(self):
        all_rds_details = self.get_all_rds_details()

        # Save the details to a file named 'rds_data.json'
